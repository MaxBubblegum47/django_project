...
- Pillow~=8.3.1
- model-bakery~=1.3.2
Potete installare singolarmente i plugin con il comando pip/pip3 install <nome_plugin>, oppure eseguire il seguente comando per installarli tutti in una sola volta: pip install -r requirements.txt
